                ...
                <div>
                    ...
                    <div v-if="$route.query.status=='S'">
                        ...
                        <van-cell title="考评人" value="请选择">
                            <template #default>
                                <span v-if="form.gradePersonnelName==null">admin</span>
                    ...
                    <div class="contentBox">
                        ...
                        >
                            ...
                            <el-table-column
                                ...
                                label="自评等级"
                                align="center"
                                v-if="form.type=='B'&&$route.query.status!='W'"
                            >
                                <template slot-scope="scope">
                                    <span v-if="scope.row.detailLevel">{{scope.row.detailLevel}}</span>
                                    <!-- <van-button
                                        v-else
                                        round
                                        type="info"
                            ...
                            >
                                <template slot-scope="scope">
                                    <input
                                        @blur="inputValue(scope.row.checkScore,scope.row.score,scope.$index,scope.row)"
                                        type="number"
                                        class="inputWidth"
                                        max="100"
                                        maxlength="2"
    ...
    methods: {
        ...
        submit() {
            for (let i = 0; i < this.form.gradeStandard.length; i++) {
                if (!this.form.gradeStandard[i].checkScore) {
        ...
        inputValue(number, max, index, row) {
            ...
            if (Number(number) <= Number(max) && Number(number) >= 0) {
            } else {
