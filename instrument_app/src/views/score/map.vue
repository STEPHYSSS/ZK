<template>
    <div class="outBox">
        <van-nav-bar title="地图定位" left-arrow right-text="确定" fixed @click-left="onClickLeft"
                        ...
                        if (this.getStatus() == BMAP_STATUS_SUCCESS) {
                            ...
                            if (r.accuracy == null) {
                             ...
                             _this.currentLocation =
                                ...
                                _this.value='定位成功'
                                alert('定位成功！')
                            // alert(_this.currentLocation)
                            //     myposition = new BMap.Point(
                            //     r.point.lng,
                            //     r.point.lat
                            // );
