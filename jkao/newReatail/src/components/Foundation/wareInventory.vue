  ...
  <div class="wareInvenStock minimum minWidth1600">
    <div class="StockBox">
      ...
      <el-row class="rowSpacing">
        ...
        <el-col :span="6" class="textAlignCenter">
          <div>
            <span class="textTitle70px">盘点仓库：{{status}}</span>
            <div class="TongYiInput">
            ...
            <template scope="scope">
              ...
              >
                <div class="dis" @click="Entering(scope.row.code)">
                  <img src="@/assets/entering_icon.png" class="codesty" />
                </div>
              </el-tooltip>
              <el-tooltip
                class="item"
              ...
              >
                <div class="dis" @click="reCheck(scope.row.code)">
                  <img src="@/assets/re-check_icon.png" class="codesty" />
                </div>
              </el-tooltip>
              <el-tooltip
                class="item"
              ...
              >
                <div class="dis" @click="cancellation(scope.row.code)">
                  <img src="@/assets/cancellation_icon.png" class="codesty" />
                </div>
              </el-tooltip>
              <el-tooltip
                class="item"
              ...
              >
                <div class="dis" @click="examine(scope.row.code)">
                  <img src="@/assets/chaxun_icon.png" class="codesty" />
                </div>
              </el-tooltip>
            </template>
          </el-table-column>
...
export default {
  ...
  methods: {
    getWareInventory(pageNum, pageSize) {
      this.$axios({
        url: window.apiWare + "inventory/list",
        method: "POST",
