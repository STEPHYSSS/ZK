        ...
        <el-table :data="tableData" style="width: 100%;">
          ...
          <el-table-column label="操作" align="center" fixed="right">
            <template scope="scope">
              ...
              >
                <img src="@/assets/chaxun_icon.png" @click="chakanP(scope.row.code)" class="codesty" alt />
              </el-tooltip>
              <el-tooltip class="item" effect="dark" content="编辑" placement="bottom" v-show="scope.row.status=='1'">
                <img src="@/assets/xiugai_icon.png" @click="editRow(scope.row.code)" class="codesty" alt />
              </el-tooltip>&nbsp;&nbsp;&nbsp;&nbsp;
              <el-tooltip class="item" effect="dark" content="删除" placement="bottom" v-show="scope.row.status=='1'">
                <img src="@/assets/shanchu_icon.png" @click="delPanRow(scope.row.code)" class="codesty" alt />
              </el-tooltip>
...
export default {
  ...
  methods: {
    ...
    inventoryList(pageNum, pageSize) {
      ...
      that
        .$axios({
          url: window.apiStore + "inventory/list",
          method: "POST",
    ...
    delPanRow(code) {
      this.$axios({
        url: window.apiStore + "inventory/delete",
        method: "POST",
        headers: { "content-type": "application/x-www-form-urlencoded" },
        data: qs.stringify({
          code: code,
