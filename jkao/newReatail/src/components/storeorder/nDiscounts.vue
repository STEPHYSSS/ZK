<template>
  <div class="productSales">
    <!-- <el-breadcrumb separator-class="el-icon-arrow-right" class="nav">
      ...
      <el-breadcrumb-item>第N件优惠</el-breadcrumb-item>
    </el-breadcrumb>-->
    <div class="storeBox">
      <div class="store_Box">
        <p class="store_tit">第N件优惠</p>
          ...
          <el-table :data="list1" style="width: 100%;">
            ...
            <el-table-column label="操作" align="center">
              <template scope="scope">
                ...
                >
                  <img src="@/assets/jinyong_icon.png" @click="modify(scope.row.id)" />
                </el-tooltip>
...
export default {
  ...
  methods: {
    getList() {
      this.$axios
        .post("/sys/promote/preferential/list", qs.stringify(this.list2))
        .then(res => {
    ...
    modify(id) {
      ...
      this.$axios
        .post(
          "/sys/promote/preferential/modify",
          qs.stringify({
            token: sessionStorage.getItem("token"),
            promoteId: codeId
          })
...
.productSales .store_Box12 {
  overflow: hidden;
  position: relative;
  height: 634px;
}
.productSales .ndisHide {
  position: absolute;
  left: 0;
  top: 0;
  right: -17px;
