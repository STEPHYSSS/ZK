        ...
        <div style="float:left;height:68px;">
          <div class="chooDrop">
            <p class="el-dropdown-link" style="display:inline-block;line-height:64px">
              <span style="font-size: 22px;">仓库后台</span>               
            </p>
            <!-- <el-dropdown trigger="click">
              <p class="el-dropdown-link" style="display:inline-block;line-height:64px">
                <span style="font-size: 22px;">仓库后台</span>
                <sub>(<i class="el-icon-arrow-down el-icon--right">切换</i>)
                </sub>
              </p>
              <el-dropdown-menu slot="dropdown">
                <router-link to="/storeManage">
                  <el-dropdown-item>运营后台</el-dropdown-item>
                </router-link>
                <router-link to="/choose">
                  <el-dropdown-item>门店</el-dropdown-item>
                </router-link>
    ...
    <div class="content">
      ...
      >
        ...
        >
          ...
          />
          <img
            src="./Uimage/storemanagement_icon1.png"
            class="iconImgBox"
