  ...
  <div id="turnWarehouseList">
    ...
    <div class="boxs">
      ...
      <el-table :data="tableData" style="width: 100%;" border max-height="650">
        <el-table-column label="转移单号" align="center" prop="code" width="160"></el-table-column>
        ...
        <el-table-column label="转出仓库编号" align="center" width="150" prop="warehouseCodeOut"></el-table-column>
        <el-table-column label="转入仓库编号" align="center" width="150" prop="warehouseCodeIn"></el-table-column>
        <el-table-column label="转移品项数" align="center" prop="item"></el-table-column>
        <el-table-column label="转移总数" align="center" prop="count"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.$axios
        .post(
          this.reqApi.xinls + `/exam/warehouse/transfer/list`,
          qs.stringify({
            token: sessionStorage.getItem("token"),
    ...
    del() {
       this.$axios
        .post(
          this.reqApi.xinls + `/exam/warehouse/transfer/delete`,
          qs.stringify({
            token: sessionStorage.getItem("token"),
            questionCode: sessionStorage.getItem("questionUUid"),
            code: this.delCode
