        ...
        <div class="right" style="width:100%;">
          ...
          <div class="tab">
            ...
            >
              <!-- selection-change -->
              <!-- @select="commodityList" -->
              <el-table-column type="selection" width="55" class="leftTitle" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    queding() {
      ...
      this.$axios
        .post(
          this.reqApi.xinls + `/exam/warehouse/transfer/insert`,
          qs.stringify({
            token: sessionStorage.getItem("token"),
            questionCode: sessionStorage.getItem("questionUUid"),
            warehouseCodeIn: this.warehouseCode1,
...
#turnWarehouseAdd .billMaList,.right .tab {
  /* padding-left: 35px;
  padding-right: 30px; */
  margin: 0 20px;
}
