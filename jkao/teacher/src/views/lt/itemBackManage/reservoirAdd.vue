    ...
    <div class="storehouseAdd minWidth1600">
        <div class="storehousebox">
            <div class="storehouse_box">
                <div class="block">
                    <h3 class="demonstration" v-if="this.$route.query.code">库区修改</h3>
                    <h3 class="demonstration" v-else>库区新增</h3>
                    <el-form
                        :model="ruleForm"
                        :rules="rules"
                        ref="ruleForm"
                    ...
                    >
                        <div class="aaa">
                            <el-form-item label="库区名称：" prop="name">
                                <p class="sotlname">
                                    <el-input class="inputWith" type="text" v-model="ruleForm.name" placeholder="请输入"></el-input>
                                </p>
                            </el-form-item>
                        </div>
                        <div class="aaa">
                            <el-form-item label="所属仓库：" prop="warehouseCode">
                                <p class="sotlname">
                                    <el-select class="inputWith" placeholder="请选择" v-model="ruleForm.warehouseCode">
                                        <el-option
