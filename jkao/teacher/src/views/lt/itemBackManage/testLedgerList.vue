<template>
  <el-card class="new-class f-new box-card" id="accountSet">
    ...
    >
      <el-table-column prop="name" label="账套名称" align="center" max-width="300px" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="remark" label="备注" align="center"  max-width="300px" :show-overflow-tooltip="true"></el-table-column>
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          ...
          <el-tooltip class="item" effect="dark" content="详情" placement="bottom">
            <span class="cur-point dis-inline-block">
              <img src="@/assets/images/xiangqing_icon.png" @click="detail(scope.row)">&nbsp;&nbsp;&nbsp;
            </span>
          </el-tooltip>
           <el-tooltip class="item" effect="dark" content="账套导出" placement="bottom">
            <span class="cur-point dis-inline-block" @click="exportAccountSet(scope.row)">
              账套导出
            </span>
          </el-tooltip>
          <!-- <el-tooltip class="item" effect="dark" content="账套导入" placement="bottom">
            <span class="cur-point dis-inline-block" @click="importAccountSet()">
              账套导入
               </span>
          </el-tooltip> -->
          ...
          <!-- <el-tooltip class="item" effect="dark" content="账套数据" placement="bottom">
                        <span class="cur-point dis-inline-block">
                            <img
                                src="@/assets/images/zicejilu_icon.png"
                                @click="zhangtao(scope.row)"
                            />&nbsp;&nbsp;&nbsp;
                        </span>
          </el-tooltip>-->
    ...
    <el-dialog title="提示" :visible.sync="dialogVisible" width="450px">
      ...
      >
        <el-form-item label="账套名称" prop="name">
          <el-input class="inputWidth" maxlength="50" v-model="ruleForm.name"
          ></el-input>
        </el-form-item>
    ...
    <el-dialog title="提示" :visible.sync="dialogVisible1" width="450px">
      ...
      >
        <el-form-item label="账套名称" prop="name">
          <el-input class="inputWidth" v-model="ruleForm1.name"
          maxlength="50"
          ></el-input>
        </el-form-item>
        <el-form-item label="备注">
...
export default {
  ...
  methods: {
    ...
    exportAccountSet(row){
      ...
      return
      window.location.href='http://47.103.211.239:8086/exam/accouunt/output?accountCode=14db64b8010040e283f31d059614d03f'
      // return;
      this.accountCode='14db64b8010040e283f31d059614d03f'
        let url="http://47.103.211.239:8086/exam/accouunt/output?accountCode=14db64b8010040e283f31d059614d03f"
        this.$utils({
          url:url,
          method:'post',
          headers: {                                       
    ...
    Panchange(e) {
      if (e == null) {
        ...
        this.formInline.createTimeEnd = this.$moment(e[1]).format("YYYY-MM-DD");
      }
    },
    // 搜索
    search() {
