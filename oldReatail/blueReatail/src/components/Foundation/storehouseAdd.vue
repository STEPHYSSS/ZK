              ...
              <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="仓库属性：" prop="temperature">
                        <p class="sotlname">
                            <el-select placeholder="请选择属性" v-model="ruleForm.temperature">
                                <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.name"></el-option>
                            </el-select>
                        </p>
                    </el-form-item>
                </div>
                <div class="aaa">
                    <el-form-item label="所在区域：">
                        <p class="cit">
                            <el-select v-model="ruleForm.inProvince" placeholder="请选择" @change="chooseProvince">
