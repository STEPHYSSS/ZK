        ...
        >
            ...
            <span class="box1">
                ...
                >
                    ...
                    <el-table-column align="center" prop="groupLead" label="团长价">
                        <template slot-scope="{row}">
                            ...
                            <input
                                ...
                                min="1"
                                maxlength="10"
                                v-model="row['groupLead']"
                            />
                        </template>
                    </el-table-column>
                    <el-table-column align="center" prop="groupSub" label="团员价">
                        <template slot-scope="{row}">
            ...
            <template slot-scope="scope">
              <span>{{scope.row['promotePrice']}}</span>
                    ...
                    <el-table-column align="center" prop="groupNumber" label="开团数量">
                        <template slot-scope="scope">
                            <input
                                type="number"
                ...
                <el-form-item label="是否包邮" prop="name">
                    <el-radio-group v-model="ruleForm.freeDeliver">
                        <el-radio v-model="ruleForm.freeDeliver" label="Y">是</el-radio>
                        <el-radio v-model="ruleForm.freeDeliver" label="N">否</el-radio>
                    </el-radio-group>&nbsp;&nbsp;&nbsp;&nbsp;邮费：
                    <el-input class="select1" v-model="ruleForm.deliverMoney"></el-input>
                </el-form-item>
                <el-form-item label="成团有效期(小时)" prop="name">
                    <el-input class="inputWidth" v-model="ruleForm.validHour"></el-input>
                </el-form-item>
            </span>
            <span class="box1">
                <div class="activityTitle">
                ...
                <el-form-item label="活动封面图" label-width="120px">
                    <el-upload
...
export default {
    ...
    methods: {
        ...
        reset() {
            ...
            this.ruleForm.limitNumber = "";
            this.ruleForm.deliverMoney = "";
            this.ruleForm.validHour = "";
        ...
        submit() {
            ...
            console.log(this.ruleForm.buyerScope);
            //   会员
            ...
            if (!this.ruleForm.memberNumber) {
                return this.$message.error("请填写参团人数");
            }
            if (!this.ruleForm.limitNumber) {
                return this.$message.error("请填写限购数量");
            }

            if (this.selectGoodsList.length == 0) {
                return this.$message.error("请选择参加商品！");
            }
            if (this.ruleForm.freeDeliver == "N") {
                if (!this.ruleForm.deliverMoney) {
                    return this.$message.error("请填写运费");
                }
            }
            // 参加商品
            ...
            for (const i of this.ruleForm.goodsList) {
                if (!i.groupLead) {
                    return this.$message.error("请填写团长价");
                }
                if (!i.groupSub) {
                    return this.$message.error("请填写团员价");
                }
                if (!i.groupNumber) {
                    return this.$message.error("请填写开团数量");
                }
            }
            if (!this.ruleForm.validHour) {
                return this.$message.error("请填写开团有效期!(小时）");
            }
            ...
            this.$axios
                .post(
                    ...
                    qs.stringify({
                        ...
                        memberNumber: this.ruleForm.memberNumber,
                        limitNumber: this.ruleForm.limitNumber,
                        freeDeliver: this.ruleForm.freeDeliver,
                        deliverMoney: this.ruleForm.deliverMoney,
                        validHour: this.ruleForm.validHour,
                        bannerImage: JSON.stringify(this.resourceCodes),
            ...
            this.$axios
                ...
                .then(res => {
                    if (res.data.code === "0000") {
                        ...
                        // console.log(this.ruleForm.levelList)
                        if (this.ruleForm.levelList.length > 0) {
                        ...
                        // console.log(this.ruleForm.bannerImage, "111111");
                        // console.log(this.resourceCodes, "222222");
                        if (this.ruleForm.bannerImage) {
                            this.fileList = [];
                            this.resourceCodes = JSON.parse(
                                this.ruleForm.bannerImage
                            );
                            // console.log(this.resourceCodes, "333333");
                            if (this.resourceCodes.length > 0) {
