<template>
  <div class="goodsDetail">
    ...
    <!-- <button class="CouponbtnbackC" @click="goback">返回</button>-->
            ...
            <div class="imgInfoBox">
              <div class="img1">
                ...
                <div class="imgRight">
                  <ul>
                    <li class="inline">
                      <img :src="listImg" @click="readImageList(listImg)" class="imgWit" />
                    </li>
                    <el-dialog
      ...
      _this
        ...
        .then(res => {
          ...
          if (code == "0000") {
            ...
            // }
            // let url = "http://192.168.1.202:8080"
             _this.listImg = window.apiImg2 +  _this.detailInfo.listImage;
