<template>
  <div class="receipts">
    ...
    <div class="little">
      ...
      <!-- <div style="background-color:pink;height:300px;">
        <ul class="menuBox">
          <li class="first-li">商品名称/货号</li>
          <li class="second-li">数量</li>
          <li class="third-li">金额</li>
        </ul>
        <ul>
          <p class="productName">乐事大波浪原味薯片</p>
          <li style="background-color:#eee">2055423</li>
        ...
        <ul>
          ...
          <li style="background-color:blue">x1</li>
          <li style="background-color:yellow">
            <span>6.8</span>
            <span>-1.5</span>
            <ul>
              <li style="background-color:yellow">6.8</li>
              <li style="background-color:yellow">-1.5</li>
            </ul>
          </li>
        </ul>
